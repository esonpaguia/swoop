$(function($) {
	...
	var hyper = {
		...
		'map'   : {
			...
			'pins'    : {
				'start'  : {
					'icon'   : '/assets/pin-a.png',
					'alt'    : '/assets/dot-a.png',
					'shadow' : '/assets/pin-shadow.png'
				},
				'end'    : {
					'icon'   : '/assets/pin-b.png',
					'alt'    : '/assets/dot-b.png',
					'shadow' : '/assets/pin-shadow.png'
				},
				'camera' : {
					'icon'   : new google.maps.MarkerImage('/assets/cross.png', null, null, new google.maps.Point(20, 20)),
					'shadow' : '/assets/cross-shadow.png'
				},
				'pivot'  : {
					'icon'   : '/assets/heading.png'
				}
			},
			'drag'    : true
		},
	...
	var setHeadingImage	= function(pin, position, prefix) {
		...
		pin.setIcon('/assets/pins/pin_'+prefix+''+img_index+'.png');
	...
	$.each(playlistItems, function(i) {
		...
		$this.css({
			'background' : 'url(assets/previews/'+imgSrc+'.gif) no-repeat'
		});
	});
	...
	// var panoBgCss = 'url(/assets/bg/'+panoBg+'.jpg) cover no-repeat 50% 50%';
	var panoBgCss = 'url(/assets/bg/'+panoBg+'.jpg)';
	// random bg image
